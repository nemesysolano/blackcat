...
def db_config():
    ...
    redis_port = int(database_config["redis_port"])
    redis_database = int(database_config["redis_database"])
    return connection_string, sqlalchemy_url, redis_host, redis_port, redis_database