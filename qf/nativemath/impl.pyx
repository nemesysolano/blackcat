...
def get_fractional_signal(double L0, double L, double Lambda, double Lambda_hat, double f, double f_mean, double f_std):
    """
    ...
    """
    return calculate_fractional_signal_cy(L0, L, Lambda, Lambda_hat, f, f_mean, f_std)    
