...
#define F_STD_K_FACTOR  2

int calculate_fractional_signal(double L0, double L, double Lambda, double Lambda_hat, double f, double f_mean, double f_std, double order);
